# Generated from c:\Users\VAIO\Desktop\compiladores\antlr\api\antlr\MyGrammar.g by ANTLR 4.9.2
# encoding: utf-8
from antlr4 import *
...
class MyGrammarParser ( Parser ):
    ...
    def prog(self):
        ...
        try:
            ...
            while _la==MyGrammarParser.T__4 or _la==MyGrammarParser.INT:
                self.state = 4
                self.expr(0)
                self.state = 5
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [MyGrammarParser.INT]:
                ...
                pass
            elif token in [MyGrammarParser.T__4]:
                self.state = 14
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 21
                        _la = self._input.LA(1)
                        if not(_la==MyGrammarParser.T__0 or _la==MyGrammarParser.T__1):
